A ChatGPT LLM Model Implementation specifically for helping parse the resume and to find jobs based on the resume parsed and to help generate linkedin connection invites.
